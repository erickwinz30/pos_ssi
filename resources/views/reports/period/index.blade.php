<x-app-layout>
  ...
  @section('content')
    <div class="mx-auto max-w-270">
      ...
      <div class="mb-6 flex flex-col gap-3 sm:flex-row sm:items-center sm:justify-between">
        ...
        <nav>
          <ol class="flex items-center gap-2">
            <li class="font-medium text-primary">Report - Periode</li>
          </ol>
        </nav>
      </div>
      <!-- Breadcrumb End -->
      ...
      <div
        ...
        <h3 class="text-title-md3 font-bold text-black dark:text-white mb-4">
          Filter :
        </h3>
        <form action="{{ route('reports.periode.index') }}" method="GET">
        ...
        <div class="max-w-full overflow-x-auto">
          ...
          <table class="w-full table-auto mb-5">
            ...
            <tbody>
              ...
              @if (count($reports) > 0)
                <tr class="bg-gray-2">
                  <td class="border-b border-[#eee] px-4 py-5 pl-9 dark:border-strokedark xl:pl-11" colspan="2">
                    <h5 class="font-bold text-black dark:text-white">Grand Total</h5>
                  </td>
                  <td class="border-b border-[#eee] px-4 py-5 dark:border-strokedark">
                    <p class="text-black dark:text-white font-bold">
                      Rp {{ number_format($reports->sum('total_sales'), 0, ',', '.') }}
                    </p>
                  </td>
                </tr>
              @endif
  ...
  @push('js')
    ...
    <script src="{{ asset('js/reports/period.js') }}"></script>
  @endpush
