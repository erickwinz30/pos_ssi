      ...
      <div class="mb-6 flex flex-col gap-3 sm:flex-row sm:items-center sm:justify-between">
        ...
        <nav>
          <ol class="flex items-center gap-2">
            <li class="font-medium text-primary">Create Product
            </li>
          </ol>
        </nav>
      </div>
              ...
              <div class="mb-5.5">
                <div class="w-full">
                  ...
                  <div class="relative">
                    ...
                    <input
                      class="w-full rounded border border-stroke py-3 pl-11.5 pr-4.5 font-medium text-black focus:border-primary focus-visible:outline-none dark:border-strokedark dark:bg-meta-4 dark:text-white dark:focus:border-primary"
                      type="number" name="price" id="price" value="{{ @old('price') }}" />
                  </div>
                  @error('price')
                    <div class="alert alert-danger">{{ $message }}</div>
                  @enderror
              ...
              <div class="mb-5.5">
                <div class="w-full">
                  ...
                  <div class="relative">
                    ...
                    <select class="w-full rounded border border-stroke px-4.5 pl-11.5 py-3 font-medium text-balck"
                      name="is_having_stock" id="is_having_stock">
              ...
              <div class="mb-5.5">
                <div class="w-full">
                  ...
                  <div class="relative">
                    ...
                    <input
                      class="w-full rounded border border-stroke py-3 pl-11.5 pr-4.5 font-medium text-black focus:border-primary focus-visible:outline-none dark:border-strokedark dark:bg-meta-4 dark:text-white dark:focus:border-primary"
                      type="file" name="picture" id="picture" value="{{ @old('picture') }}" />
                  </div>
                  @error('code')
                    <div class="alert alert-danger">{{ $message }}</div>
                  @enderror
